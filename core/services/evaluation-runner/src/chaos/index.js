...
var logger_1 = require("@fiora/logger");
var chaosLogger = (0, logger_1.createLogger)({ service: 'chaos-engine' });
var ChaosEngine = /** @class */ (function () {
    function ChaosEngine() {
    }
    /**
     * Intentionally delays execution to test latency constraints and timeout handling.
     */
    ChaosEngine.simulateAgentTimeout = function () {
        return __awaiter(this, arguments, void 0, function (ms) {
            if (ms === void 0) { ms = 3000; }
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chaosLogger.warn("[CHAOS] Simulating agent timeout of ".concat(ms, "ms..."));
     ...
     */
    ChaosEngine.injectMalformedPayload = function (payload) {
        chaosLogger.warn('[CHAOS] Injecting malformed payload (stripping execution_id)...');
        var corrupted = __assign({}, payload);
     ...
     */
    ChaosEngine.simulatePolicyRejection = function () {
