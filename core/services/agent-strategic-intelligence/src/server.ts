...
import { detectOrganizationalPattern } from '@fiora/organizational-learning';
import { generateGovernedForecast } from '@fiora/forecast-governance';
import { detectOrganizationalDrift } from '@fiora/organizational-drift';
